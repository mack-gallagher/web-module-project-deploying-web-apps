    ...
    <div className="Board">
      <div className="row y0">
        <div className="square y0 x0 light" 
          onClick={active?()=>dispatch(movePiece[activePiece.y,activePiece.x],[0,0]):dispatch(activatePiece([0,0]))}
        >
          { board[0][0].piece }
        </div>
        <div className="square y0 x1 dark"
          onClick={active?()=>dispatch(movePiece[activePiece.y,activePiece.x],[0,1]):dispatch(activatePiece([0,1]))}
        >
          { board[0][1].piece }
        </div>
        <div className="square y0 x2 light"
          onClick={active?()=>dispatch(movePiece[activePiece.y,activePiece.x],[0,2]):dispatch(activatePiece([0,2]))}
        >
          { board[0][2].piece }
        </div>
        <div className="square y0 x3 dark"
          onClick={active?()=>dispatch(movePiece(activePiece.y,activePiece.x),[0,3]):dispatch(activatePiece([0,3]))}
        >
          { board[0][3].piece }
        </div>
        <div className="square y0 x4 light"
          onClick={active?()=>dispatch(movePiece(activePiece.y,activePiece.x),[0,4]):dispatch(activatePiece([0,4]))}
        >
          { board[0][4].piece }
        </div>
        <div className="square y0 x5 dark"
          onClick={active?()=>dispatch(movePiece(activePiece.y,activePiece.x),[0,5]):dispatch(activatePiece([0,5]))}
        >
          { board[0][5].piece }
        </div>
        <div className="square y0 x6 light"
          onClick={active?()=>dispatch(movePiece(activePiece.y,activePiece.x),[0,6]):dispatch(activatePiece([0,6]))}
        >
          { board[0][6].piece }
        </div>
